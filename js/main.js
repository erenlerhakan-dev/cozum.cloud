    ...
    CRUMINA.layerInit = function() {
        ...
        e(".swiper-container").each(function() {
            ...
            var o = t.data("effect") ? t.data("effect") : "slide",
                ...
                m = t.data("autoplay") ? parseInt(t.data("autoplay"), 10) : 0,
                f = !!t.hasClass("auto-height"),
                h = !!t.data("nospace") && t.data("nospace"),
                v = !!t.data("centered-slider") && t.data("centered-slider"),
                g = t.data("stretch") ? t.data("stretch") : 0,
                w = t.data("depth") ? t.data("depth") : 0,
                y = l > 1 && 1 != h ? 20 : 0;
            l > 1 && (s = {
                480: {
                    slidesPerView: 1,
        ...
        }), e("article .btn-prev").on("click", function() {
            var i = e(this).closest(".crumina-module-slider").find(".swiper-container").attr("id");
            n["swiper-" + i].slidePrev()
        }), e("article .btn-next").on("click", function() {
            var i = e(this).closest(".crumina-module-slider").find(".swiper-container").attr("id");
            n["swiper-" + i].slideNext()
            ...
            var s = e(this).parent().find(".slides-item").index(this);
            return a.slideTo(s + 1), e(this).parent().find(".slide-active").removeClass("slide-active"), e(this).addClass("slide-active"), a.update(), !1
        })
        ...
        m.style.visibility = "visible", f.onclick = function() {
            m.className = "menu-icon-wrapper scaled", h ? (n(d), s(u), n(p)) : (o(d), u.draw(t, a, .7, {
                delay: .1,
        ...
        e(".js-popup-clear-input").siblings("input").val("").focus()
        ...
        }), e(".js-pricing-switcher").on("click", function() {
        ...
        }), CRUMINA.fixedHeader(), CRUMINA.initSwiper(), CRUMINA.equalHeight(), CRUMINA.mediaPopups(), CRUMINA.IsotopeSort(), CRUMINA.parallaxFooter(), CRUMINA.preloader(), CRUMINA.layerInit(), CRUMINA.countdown(), CRUMINA.counters(), CRUMINA.progresBars()
