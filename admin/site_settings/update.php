...
$site_contact_email_port     = $_POST['site_contact_email_port'];
$site_contact_email_stmp     = $_POST['site_contact_email_stmp'];
$site_contact_email_ssl      = $_POST['site_contact_email_ssl'];
...
$site_recaptcha_key          = $_POST['site_recaptcha_key'];
$site_recaptcha_secret       = $_POST['site_recaptcha_secret'];
...
site_contact_email_port     = ?,
site_contact_email_stmp     = ?,
site_contact_email_ssl      = ?,
site_footer_text            = ?,
site_analytics_code         = ?,
...
WHERE site_id               = ?
", array($site_name,$site_title,$site_description,$site_phone,$site_contact_email,$site_contact_email_pass,$site_contact_email_port,$site_contact_email_stmp,$site_contact_email_ssl,$site_footer_text,$site_analytics_code,$site_google_webmasters_code,$site_bing_webmasters_code,$site_yandex_webmasters_code,$site_google_maps_key,$site_facebook,$site_twitter,$site_instagram,$site_company_name,$site_address_1,$site_address_2,$site_phone_1,$site_phone_2,$site_email,$site_whatssapp,$site_tawkto,$site_gps,$site_sms_phone,$site_sms_pass,$site_sms_title,$site_transfer_shuttle,$site_recaptcha_key,$site_recaptcha_secret,$site_id));
