...
<div class="col-md-6">
<div class="form-group">
<label>Sistem Email Port'u</label>
<input type="text" class="form-control" name="site_contact_email_port" onkeypress="return h_isNumber(event)" value="<?php echo $data['site_contact_email_port']; ?>" maxlength="11" required="">
</div>
</div>

<div class="col-md-6">
<div class="form-group">
<label>Sistem Email STMP Port'u</label>
<input type="text" class="form-control" name="site_contact_email_stmp" value="<?php echo $data['site_contact_email_stmp']; ?>" maxlength="100" required="">
</div>
</div>

<div class="col-md-6">
<div class="form-group">
<label>Sistem Email SSL</label>
<input type="text" class="form-control" name="site_contact_email_ssl" value="<?php echo $data['site_contact_email_ssl']; ?>" maxlength="10" required="">
</div>
</div>
...
<input type="text" class="form-control" name="site_recaptcha_key" value="<?php echo $data['site_recaptcha_key']; ?>" maxlength="250" required="">
</div>
</div>
...
<input type="text" class="form-control" name="site_recaptcha_secret" value="<?php echo $data['site_recaptcha_secret']; ?>" maxlength="250" required="">
</div>
</div>
