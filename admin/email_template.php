...
<img src="<?php echo SITE_URL; ?>images/<?php echo $sitesettings['site_logo']; ?>" alt="<?php echo $sitesettings['site_name']; ?>"/>
</div>
</div>
</td>
<td width='20'></td>
...
<div class="contentEditable">
<?php echo $sitesettings['site_phone_1']; ?>
</div>
</div>
</td>
</tr>
...
<div class="contentEditableContainer contentImageEditable">
<div class="contentEditable">
<img src="<?php echo SITE_URL; ?>images/email/<?php echo $email_template['header_photo']; ?>" alt="<?php echo $sitesettings['site_name']; ?>" width='600' height='226' data-default="placeholder" data-max-width="600" />
</div>
</div>
</td>
</tr>
...
<div class="contentEditableContainer contentImageEditable">
<div class="contentEditable">
<img src="<?php echo SITE_URL; ?>images/email/<?php echo $email_template['box1_photo']; ?>" alt="<?php echo $sitesettings['site_name']; ?>" width='100' height='100' data-default="placeholder" data-max-width="150" />
</div>
</div>
</td>
<td width='20'></td>
...
<div class="contentEditableContainer contentImageEditable">
<div class="contentEditable">
<img src="<?php echo SITE_URL; ?>images/email/<?php echo $email_template['box2_photo']; ?>" alt="<?php echo $sitesettings['site_name']; ?>" width='100' height='100' data-default="placeholder" data-max-width="150" />
</div>
</div>
</td>
<td width='20'></td>
...
<div class="contentEditableContainer contentImageEditable">
<div class="contentEditable">
<img src="<?php echo SITE_URL; ?>images/email/<?php echo $email_template['box3_photo']; ?>" alt="<?php echo $sitesettings['site_name']; ?>" width='100' height='100' data-default="placeholder" data-max-width="150" />
</div>
</div>
</td>
<td width='20'></td>
...
<img src="<?php echo SITE_URL; ?>images/email/<?php echo $email_template['social_logo1']; ?>" alt="<?php echo $sitesettings['site_name']; ?>" width='50' height='50' data-max-width="50" />
</a>
</div>
</div>
</td>
...
<img src="<?php echo SITE_URL; ?>images/email/<?php echo $email_template['social_logo2']; ?>" alt="<?php echo $sitesettings['site_name']; ?>" width='50' height='50' data-max-width="50" />
</a>
</div>
</div>
</td>
...
<br><br>
<?php echo $sitesettings['site_address_1']; ?> <br>
<?php echo $sitesettings['site_address_2']; ?> <br>
<?php echo $sitesettings['site_phone_1']; ?> <br>
<?php echo $sitesettings['site_email']; ?> <br>
</p>
</div>
</div>
</td>
